const FEATURES = [
  {
    ...
    desc: 'Instant answers from 10 company policy documents using keyword-based retrieval. Ask about compliance, HR policies, code of conduct, expenses, and benefits.',
  },
  {
